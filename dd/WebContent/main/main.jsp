...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
		    $(function(){
		    	//左侧
		    	$("#left").load("/dd/main/category.do");
		    	
		    	//中栏
				$("#recommend").load("/dd/main/recommend.do");
				$("#new").load("/dd/main/new.do");
				$("#hot").load("/dd/main/hot.do");
		    });
        </script>
	</head>
	<body>
		...
		<div class="book">
			...
			<!-- id=left的div自动加载，自动刷新。。。
			调用action，转发到对应的jsp ，刷新当前的div -->
			...
			<div class="book_center">
				...
				<!--推荐图书开始-->
				<div class="book_c_border2" id="recommend">
